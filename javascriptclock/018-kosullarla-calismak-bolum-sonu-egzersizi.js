...
let sinavSonucu = prompt("Sınav Sonucunu giriniz: ");
let yaziBilgisi;
...
if (sinavSonucu >= 0 && sinavSonucu <= 100) {
  ...
  if (sinavSonucu >= 90) {
    yaziBilgisi += " AA";
  } else if (sinavSonucu >= 85) {
    yaziBilgisi += " BA";
  } else if (sinavSonucu >= 80) {
    yaziBilgisi += " BB";
  } else if (sinavSonucu >= 75) {
    yaziBilgisi += " CB";
  } else if (sinavSonucu >= 70) {
    yaziBilgisi += " CC";
  } else if (sinavSonucu >= 65) {
    yaziBilgisi += " DC";
  } else if (sinavSonucu >= 60) {
    yaziBilgisi += " DD";
  } else if (sinavSonucu >= 50) {
    yaziBilgisi += " FD";
  } else if (sinavSonucu >= 0) {
    yaziBilgisi += `${FROWN} FF`;
    yaziBilgisi.classList.remove("text-primary");
    yaziBilgisi.classList.add("text-danger");
  }
} else {
  yaziBilgisi = "Bilgiler Geçerli Değil.";
}

info.innerHTML = `${yaziBilgisi} -> ${sinavSonucu}`;
